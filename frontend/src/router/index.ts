...
const candidateAndHrRoles = ['candidate', 'hr']
const governanceRoles = ['hr', 'admin']
...
const routes = [
  ...
  { path: '/capability-evolution-direct', redirect: '/capability-evolution' },
  {
    path: '/',
    ...
    children: [
      ...
      { path: 'datasets', name: 'datasets', component: () => import('@/views/Datasets.vue'), meta: { title: '权威数据源中心', roles: governanceRoles } },
      ...
      { path: 'skill-graph', name: 'skill-graph', component: () => import('@/views/SkillGraph.vue'), meta: { title: '能力图谱', roles: candidateAndHrRoles } },
      { path: 'graph-explore', redirect: '/skill-graph' },
      { path: 'capability-evolution', name: 'capability-evolution', component: () => import('@/views/CapabilityEvolution.vue'), meta: { title: '能力演化', roles: candidateAndHrRoles } },
      { path: 'resume-parser', name: 'resume-parser', component: () => import('@/views/ResumeParser.vue'), meta: { title: '简历解析', roles: candidateAndHrRoles } },
      { path: 'match-analysis', name: 'match-analysis', component: () => import('@/views/MatchAnalysis.vue'), meta: { title: '匹配分析', roles: candidateAndHrRoles } },
      { path: 'digital-interviewer', name: 'digital-interviewer', component: () => import('@/views/DigitalInterviewer.vue'), meta: { title: '数字人面试官', roles: candidateAndHrRoles } },
      { path: 'learning-path', name: 'learning-path', component: () => import('@/views/LearningPath.vue'), meta: { title: '学习路径', roles: candidateRoles } },
      { path: 'review-tasks', name: 'review-tasks', component: () => import('@/views/ReviewTasks.vue'), meta: { title: '人工审核', roles: governanceRoles } },
      { path: 'evaluation', name: 'evaluation', component: () => import('@/views/Evaluation.vue'), meta: { title: '测试评估', roles: governanceRoles } },
      { path: 'rag-admin', name: 'rag-admin', component: () => import('@/views/RagWorkflowEditor.vue'), meta: { title: 'RAG 工作流编辑器', roles: governanceRoles } },
      { path: 'settings', name: 'settings', component: () => import('@/views/Settings.vue'), meta: { title: '系统设置', roles: governanceRoles } },
