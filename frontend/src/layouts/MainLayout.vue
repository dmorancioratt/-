...
const roleRouteMap: Record<string, string[]> = {
  candidate: ['/overview', '/growth-cockpit', '/personal-center', '/skill-graph', '/capability-evolution', '/resume-parser', '/match-analysis', '/learning-path', '/digital-interviewer', '/account-settings'],
...
const groupDefs = [
  { key: 'overview', label: '总览', icon: Histogram, items: ['/overview', '/growth-cockpit', '/personal-center', '/hr-candidates'] },
...
const headerSubtitleMap: Record<string, string> = {
  '/growth-cockpit': '个人成长驾驶舱，查看技能星系与成长全景',
...
>>>>>>> 10da6016ff33d295472f1d50bb06ec7afa52e494
}
</style>
