...
.eval-page .report-title {
  color: #e8f2ff !important;
}

.eval-page .report-head small {
  color: #9db3cf !important;
}

.eval-page .report-cmd code {
...
.eval-page .report-card::before {
  opacity: 0.52 !important;
  filter: blur(46px) !important;
}

.eval-page .report-card__name {
  color: #e8f2ff !important;
}
...
.eval-page .error-block__head {
  color: #e8f2ff !important;
}

.eval-page .error-item {
...
.eval-page .err-detail {
  color: #d8e8ff !important;
}

.eval-page :deep(.panel) {
  border-color: rgba(91, 145, 220, 0.36) !important;
  background:
    radial-gradient(circle at 0% 0%, rgba(0, 200, 245, 0.1), transparent 30%),
    linear-gradient(145deg, rgba(18, 38, 78, 0.82), rgba(8, 22, 48, 0.74)),
...
.eval-page .panel-title-row {
  color: #e8f2ff !important;
}

.eval-page :deep(.el-table) {
...
.eval-page :deep(.el-table th) {
  background: rgba(20, 44, 90, 0.5) !important;
  color: #e8f2ff !important;
}

.eval-page :deep(.el-table tr) {
  background: transparent !important;
}

.eval-page :deep(.el-table--striped .el-table__body tr.el-table__row--striped td) {
  background: rgba(20, 44, 90, 0.28) !important;
}

.eval-page :deep(.el-table td),
.eval-page :deep(.el-table th.is-leaf) {
  border-color: rgba(91, 145, 220, 0.18) !important;
}

.eval-page :deep(.el-table::before) {
