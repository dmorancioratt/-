...
.life-tree-stage { position: relative; height: 650px; overflow: hidden; margin-bottom: 14px; border: 1px solid rgba(71,191,255,.22); border-radius: 12px; background: #020916; box-shadow: 0 22px 60px rgba(0,3,18,.28); }
.life-tree-stage > .life-tree { position: absolute; inset: 0; }
.tree-readiness, .tree-controls, .tree-priorities { position: absolute; z-index: 2; border-left: 2px solid rgba(70,213,247,.72); padding: 13px 14px; background: rgba(3,17,38,.82); box-shadow: 0 14px 34px rgba(0,4,16,.24); backdrop-filter: blur(9px); }
...
.progress-strip button { position: relative; display: grid; grid-template-columns: 30px minmax(0,1fr) auto; align-items: center; gap: 10px; min-height: 78px; overflow: hidden; border: 1px solid rgba(71,191,255,.2); border-radius: 10px; padding: 12px 14px 16px; color: inherit; background: rgba(5,23,52,.82); font: inherit; text-align: left; cursor: pointer; }.progress-strip button:hover { border-color: rgba(71,215,255,.5); background: rgba(8,39,78,.88); }.progress-strip .el-icon { color: #42d5fa; font-size: 22px; }.progress-strip b,.progress-strip small { display: block; }.progress-strip b { color: #f3fbff; font-size: 18px; }.progress-strip small { margin-top: 3px; color: #7f9eb6; font-size: 11px; }.progress-strip em { color: #78dff7; font-size: 11px; font-style: normal; }.progress-meter { position: absolute; right: 0; bottom: 0; left: 0; height: 3px; background: rgba(65,128,170,.13); }.progress-meter span { display: block; height: 100%; background: #36c6e8; transform-origin: left; animation: candidate-bar-enter .75s ease-out both; }
@keyframes candidate-bar-enter { from { transform: scaleX(0); } }
.workbench-grid { display: grid; grid-template-columns: minmax(0,1.5fr) minmax(330px,.7fr); gap: 14px; margin-bottom: 14px; }.weekly-list { display: grid; gap: 9px; padding: 5px 16px 17px; }.weekly-list button { display: grid; grid-template-columns: 32px minmax(0,1fr) auto; align-items: center; gap: 12px; min-height: 64px; border: 1px solid rgba(70,158,216,.17); border-radius: 9px; padding: 10px 12px; color: inherit; background: rgba(7,32,67,.52); font: inherit; text-align: left; cursor: pointer; }.weekly-list button:hover { border-color: rgba(65,210,255,.38); }.check-box { display: grid; place-items: center; width: 30px; height: 30px; border: 1px solid rgba(77,210,248,.4); border-radius: 7px; color: #83e7ff; font-weight: 900; }.weekly-list b,.weekly-list small { display: block; }.weekly-list b { color: #ecfaff; font-size: 14px; }.weekly-list small { margin-top: 5px; color: #7d9db6; font-size: 12px; }.do-now { color: #83e7ff; font-size: 12px; font-weight: 800; }
