...
<style scoped>
.candidate-dashboard { --panel: rgba(3, 28, 36, .54); --edge: rgba(34, 247, 255, .18); --cyan: #22f7ff; --text: #e5ffff; max-width: 1680px; margin: 0 auto; color: var(--text); font-family: "Microsoft YaHei", "Noto Sans SC", sans-serif; }
.cockpit-loading { position: fixed; z-index: 20; top: 18px; right: 20px; border: 1px solid var(--edge); border-radius: 999px; padding: 9px 15px; color: #9fffff; background: rgba(2, 16, 20, .62); box-shadow: 0 0 20px rgba(0, 222, 230, .16); backdrop-filter: blur(14px); font-size: 12px; }
.overview-rail { position: sticky; z-index: 5; top: 8px; display: flex; align-items: center; justify-content: center; gap: 6px; width: max-content; max-width: calc(100vw - 36px); margin: 0 auto 14px; border: 1px solid rgba(34, 247, 255, .16); border-radius: 999px; padding: 5px; background: rgba(3, 22, 28, .50); box-shadow: 0 8px 24px rgba(0, 8, 12, .20); backdrop-filter: blur(22px); }
.overview-rail a,.overview-rail button { display: inline-flex; align-items: center; gap: 5px; border: 0; border-radius: 999px; padding: 8px 12px; color: #79b3b8; background: transparent; font: inherit; font-size: 12px; text-decoration: none; cursor: pointer; }.overview-rail a:hover,.overview-rail button:hover { color: #e6ffff; background: rgba(34, 247, 255, .11); }.overview-rail button { color: #4feaff; }.overview-rail button:disabled { cursor: wait; opacity: .6; }
.career-hero { display: grid; grid-template-columns: minmax(250px, .8fr) minmax(480px, 2.15fr) minmax(260px, .84fr); min-height: 555px; overflow: hidden; border: 1px solid rgba(34, 247, 255, .16); border-radius: 20px; background: radial-gradient(circle at 50% 100%, rgba(0, 201, 210, .12), transparent 44%), rgba(2, 15, 19, .50); box-shadow: 0 24px 62px rgba(0, 10, 14, .32), inset 0 1px 0 rgba(141, 255, 255, .06); backdrop-filter: blur(17px); }
.hero-card { position: relative; z-index: 2; padding: 30px 24px; background: linear-gradient(160deg, rgba(4, 44, 54, .50), rgba(2, 18, 22, .42)); backdrop-filter: blur(17px); }.readiness-card { border-right: 1px solid rgba(34, 247, 255, .10); }.focus-card { border-left: 1px solid rgba(34, 247, 255, .10); }
.section-kicker { display: block; color: #22f7ff; font-size: 10px; font-weight: 900; letter-spacing: .14em; text-transform: uppercase; text-shadow: 0 0 8px rgba(34, 247, 255, .35); }.card-label { margin: 25px 0 8px; color: #739ea3; font-size: 12px; }.hero-card h2 { margin: 0; color: #ecffff; font-size: 21px; letter-spacing: -.04em; }.role-tag { display: inline-block; margin-top: 10px; border-radius: 5px; padding: 5px 8px; color: #7dfaff; background: rgba(34, 247, 255, .09); box-shadow: inset 0 0 0 1px rgba(34, 247, 255, .10); font-size: 11px; }.readiness-label { margin-top: 25px; }
...
.route-stop { position: absolute; z-index: 3; display: grid; grid-template-columns: 30px auto; column-gap: 7px; min-width: 135px; border: 1px solid rgba(34, 247, 255, .5); border-radius: 10px; padding: 8px 10px; color: #dfffff; background: rgba(3, 36, 44, .78); box-shadow: 0 0 18px rgba(34, 247, 255, .14); font: inherit; text-align: left; cursor: pointer; backdrop-filter: blur(8px); }.route-stop:hover { border-color: #8dffff; transform: translateY(-3px); }.route-stop b { grid-row: span 2; align-self: center; color: #22f7ff; font-size: 19px; text-shadow: 0 0 8px rgba(34, 247, 255, .55); }.route-stop span { font-size: 12px; font-weight: 800; }.route-stop small { margin-top: 3px; color: #7ab2b7; font-size: 10px; }.route-stop--one { bottom: 22px; left: 6%; }.route-stop--two { bottom: 42%; left: 34%; border-color: rgba(145, 210, 190, .40); }.route-stop--two b { color: #9ad8c5; text-shadow: 0 0 8px rgba(154, 216, 197, .30); }.route-stop--three { right: 12%; bottom: 19%; border-color: rgba(186, 142, 255, .55); }.route-stop--three b { color: #c19aff; text-shadow: 0 0 8px rgba(186, 142, 255, .4); }.target-beacon { position: absolute; z-index: 3; top: 20%; right: 7%; display: grid; justify-items: center; text-align: center; }.target-beacon span { display: block; width: 58px; height: 24px; border: 2px solid #22f7ff; border-radius: 50%; box-shadow: 0 0 0 8px rgba(34, 247, 255, .12), 0 0 20px rgba(34, 247, 255, .75); animation: beacon 2.7s ease-in-out infinite; }.target-beacon b { margin-top: 9px; color: #e5ffff; font-size: 13px; }.target-beacon small { margin-top: 2px; color: #79a5ab; font-size: 10px; }@keyframes beacon { 50% { transform: scale(1.19); box-shadow: 0 0 0 15px rgba(34, 247, 255, .03), 0 0 31px rgba(34, 247, 255, .85); } }
...
.focus-card { display: flex; flex-direction: column; }.focus-card h2 { margin-top: 12px; }.focus-skill { display: flex; align-items: center; gap: 11px; margin-top: 21px; border: 1px solid rgba(34, 247, 255, .20); border-radius: 10px; padding: 13px; background: rgba(4, 54, 63, .44); backdrop-filter: blur(12px); }.skill-icon { display: grid; place-items: center; width: 36px; height: 36px; border-radius: 50%; color: #22f7ff; background: rgba(0, 201, 210, .18); font-size: 20px; box-shadow: inset 0 0 12px rgba(34, 247, 255, .14); }.focus-skill b,.focus-skill small { display: block; }.focus-skill b { color: #ecffff; font-size: 14px; }.focus-skill small { margin-top: 5px; color: #76a3a8; font-size: 10px; }.focus-progress { height: 6px; margin: 13px 4px 0; overflow: hidden; border-radius: 6px; background: rgba(0, 142, 156, .20); }.focus-progress span { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #00c9d2, #22f7ff); box-shadow: 0 0 12px rgba(34, 247, 255, .50); }.plain-link { display: inline-flex; align-items: center; gap: 4px; margin: 11px 0 16px; border: 0; padding: 0; color: #4feaff; background: transparent; font: inherit; font-size: 11px; font-weight: 700; cursor: pointer; }.recommendation { border-top: 1px solid rgba(34, 247, 255, .12); padding-top: 17px; }.recommendation > span { color: #6c9aa0; font-size: 12px; }.recommendation button { display: grid; grid-template-columns: 28px 1fr 15px; align-items: center; gap: 8px; width: 100%; margin-top: 9px; border: 1px solid rgba(34, 247, 255, .22); border-radius: 9px; padding: 11px; color: #a8f6fb; background: rgba(6, 62, 73, .22); backdrop-filter: blur(10px); font: inherit; text-align: left; cursor: pointer; }.recommendation button:hover { border-color: rgba(141, 255, 255, .55); }.recommendation button > .el-icon:first-child { display: grid; place-items: center; width: 28px; height: 28px; border-radius: 6px; color: #22f7ff; background: rgba(0, 201, 210, .20); }.recommendation b,.recommendation small { display: block; }.recommendation b { color: #e4ffff; font-size: 11px; }.recommendation small { margin-top: 4px; color: #759da2; font-size: 10px; line-height: 1.4; }.trend-box { margin-top: auto; border-top: 1px solid rgba(34, 247, 255, .14); padding-top: 17px; }.trend-box > div { display: flex; justify-content: space-between; color: #6c9aa0; font-size: 11px; }.trend-box b { color: #9ad8c5; font-size: 16px; text-shadow: 0 0 8px rgba(154, 216, 197, .28); }.trend-box svg { display: block; width: 100%; height: 52px; margin: 5px 0; overflow: visible; }.trend-box path { fill: none; stroke: #9ad8c5; stroke-width: 2.5; filter: drop-shadow(0 0 4px rgba(154, 216, 197, .40)); }.trend-box small { display: flex; justify-content: space-between; color: #68878c; font-size: 9px; }.trend-box i { display: inline-block; width: 5px; height: 5px; margin: 0 4px; border-radius: 50%; background: #9ad8c5; }
.progress-strip { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; margin-top: 15px; }.progress-card { position: relative; display: grid; grid-template-columns: 42px minmax(0, 1fr) auto; align-items: center; gap: 11px; min-height: 91px; overflow: hidden; border: 1px solid rgba(34, 247, 255, .18); border-radius: 13px; padding: 14px 16px 18px; color: inherit; background: rgba(3, 36, 44, .66); box-shadow: inset 0 1px 0 rgba(141, 255, 255, .04); font: inherit; text-align: left; cursor: pointer; backdrop-filter: blur(14px); }.progress-card:hover { border-color: rgba(141, 255, 255, .55); transform: translateY(-2px); }.progress-icon { display: grid; place-items: center; width: 41px; height: 41px; border-radius: 50%; color: #22f7ff; background: radial-gradient(circle, rgba(34, 247, 255, .34), rgba(0, 122, 131, .12)); font-size: 22px; text-shadow: 0 0 8px rgba(34, 247, 255, .55); }.progress-copy b,.progress-copy small { display: block; }.progress-copy b { color: #e5ffff; font-size: 24px; text-shadow: 0 0 6px rgba(34, 247, 255, .25); }.progress-copy small { margin-top: 5px; color: #78a4a9; font-size: 11px; }.progress-card em { display: inline-flex; align-items: center; gap: 3px; color: #4feaff; font-size: 11px; font-style: normal; white-space: nowrap; }.progress-meter { position: absolute; right: 0; bottom: 0; left: 0; height: 3px; background: rgba(0, 142, 156, .14); }.progress-meter span { display: block; height: 100%; background: linear-gradient(90deg, #00c9d2, #22f7ff); box-shadow: 0 0 10px rgba(34, 247, 255, .55); transform-origin: left; animation: progress-in 1s ease-out both; }@keyframes progress-in { from { transform: scaleX(0); } }
.overview-section { display: grid; gap: 14px; margin-top: 15px; }.action-layout { grid-template-columns: minmax(0, 1.35fr) minmax(360px, .9fr); }.evidence-layout { grid-template-columns: minmax(0, 1.15fr) minmax(380px, 1fr); }.overview-panel { border: 1px solid rgba(34, 247, 255, .18); border-radius: 14px; background: linear-gradient(145deg, rgba(4, 46, 54, .66), rgba(2, 20, 24, .68)); box-shadow: inset 0 1px 0 rgba(141, 255, 255, .04); backdrop-filter: blur(16px); }.panel-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 15px; border-bottom: 1px solid rgba(34, 247, 255, .12); padding: 21px 22px 16px; }.panel-heading h2 { margin: 5px 0 5px; color: #e5ffff; font-size: 19px; }.panel-heading p { margin: 0; color: #6e979c; font-size: 11px; }.panel-count { border-radius: 999px; padding: 6px 10px; color: #6feaff; background: rgba(0, 201, 210, .15); font-size: 11px; white-space: nowrap; }.action-list { display: grid; gap: 8px; padding: 12px 18px 18px; }.action-list button { display: grid; grid-template-columns: 34px 1fr auto; align-items: center; gap: 12px; border: 1px solid rgba(34, 247, 255, .15); border-radius: 9px; padding: 12px; color: inherit; background: rgba(3, 36, 44, .40); font: inherit; text-align: left; cursor: pointer; backdrop-filter: blur(12px); }.action-list button:hover { border-color: rgba(141, 255, 255, .52); background: rgba(6, 66, 77, .50); }.action-list button > b { display: grid; place-items: center; width: 32px; height: 32px; border: 1px solid rgba(34, 247, 255, .28); border-radius: 8px; color: #6feaff; background: rgba(0, 142, 156, .18); font-size: 12px; text-shadow: 0 0 6px rgba(34, 247, 255, .40); }.action-list strong,.action-list small { display: block; }.action-list strong { color: #e5ffff; font-size: 13px; }.action-list small { margin-top: 5px; color: #6f9499; font-size: 11px; }.action-list em { display: inline-flex; align-items: center; gap: 3px; color: #4feaff; font-size: 11px; font-style: normal; }.milestone-list { display: grid; gap: 0; margin: 0; padding: 14px 24px 19px; list-style: none; }.milestone-list li { position: relative; display: grid; grid-template-columns: 16px 1fr; gap: 11px; padding: 8px 0 14px; }.milestone-list li:not(:last-child)::after { position: absolute; top: 25px; bottom: -1px; left: 7px; width: 1px; background: rgba(0, 142, 156, .22); content: ''; }.milestone-list li > span { position: relative; z-index: 1; width: 14px; height: 14px; margin-top: 2px; border: 2px solid #3e8f94; border-radius: 50%; background: #092c33; }.milestone-list li.done > span { border-color: #9ad8c5; background: #9ad8c5; box-shadow: 0 0 8px rgba(154, 216, 197, .38); }.milestone-list b,.milestone-list small { display: block; }.milestone-list b { color: #e5ffff; font-size: 12px; }.milestone-list small { margin-top: 4px; color: #6f9398; font-size: 10px; }
.outline-button { border: 1px solid rgba(34, 247, 255, .30); border-radius: 7px; padding: 7px 11px; color: #6feaff; background: rgba(0, 142, 156, .14); font: inherit; font-size: 11px; cursor: pointer; }.outline-button:hover { background: rgba(0, 178, 188, .24); }.profile-summary { display: flex; align-items: center; gap: 14px; padding: 21px 23px; }.profile-summary > div { flex: 1; min-width: 0; }.profile-summary b,.profile-summary small { display: block; }.profile-summary b { color: #ecffff; font-size: 14px; }.profile-summary b em { color: #22f7ff; font-size: 18px; font-style: normal; text-shadow: 0 0 8px rgba(34, 247, 255, .40); }.profile-summary small { margin-top: 6px; color: #6f959a; font-size: 11px; }.evidence-progress { height: 6px; margin-top: 12px; overflow: hidden; border-radius: 999px; background: rgba(0, 142, 156, .16); }.evidence-progress i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #00c9d2, #22f7ff); box-shadow: 0 0 10px rgba(34, 247, 255, .45); }.resume-evidence { display: grid; grid-template-columns: 36px 1fr auto; align-items: center; gap: 11px; margin: 0 22px 22px; border: 1px solid rgba(34, 247, 255, .16); border-radius: 9px; padding: 12px; background: rgba(3, 30, 37, .46); backdrop-filter: blur(12px); }.resume-icon { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 7px; color: #22f7ff; background: rgba(0, 142, 156, .20); font-size: 18px; }.resume-evidence b,.resume-evidence small { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.resume-evidence b { color: #e5ffff; font-size: 12px; }.resume-evidence small { margin-top: 4px; color: #6f9499; font-size: 10px; }.resume-evidence button { border: 0; padding: 6px 0; color: #4feaff; background: transparent; font: inherit; font-size: 11px; cursor: pointer; }.skill-cloud { display: flex; flex-wrap: wrap; gap: 8px; padding: 20px 22px 13px; }.skill-pill { display: inline-flex; align-items: center; gap: 6px; border: 1px solid rgba(34, 247, 255, .20); border-radius: 999px; padding: 7px 10px; color: #9fdfe5; background: rgba(5, 54, 64, .30); backdrop-filter: blur(10px); font: inherit; font-size: 11px; cursor: pointer; }.skill-pill:hover,.skill-pill.active { border-color: rgba(141, 255, 255, .65); color: #e5ffff; }.skill-pill small { color: #22f7ff; font-size: 9px; }.skill-pill.missing { border-color: rgba(255, 192, 72, .28); color: #ffd888; }.skill-pill.missing small { color: #ffc048; }.skill-footnote { display: flex; align-items: center; gap: 7px; margin: 0 22px 20px; color: #6f9499; font-size: 11px; }.skill-footnote .el-icon { color: #22f7ff; text-shadow: 0 0 6px rgba(34, 247, 255, .45); }
...
.overview-footer { display: flex; align-items: center; justify-content: space-between; gap: 14px; margin-top: 18px; border: 1px solid rgba(34,247,255,.16); border-radius: 10px; padding: 13px 18px; background: rgba(3,28,36,.62); backdrop-filter: blur(17px); }
.overview-footer__status { display: flex; align-items: center; gap: 10px; color: #77a0a5; font-size: 12px; }
.overview-footer__status .status-dot { width: 7px; height: 7px; border-radius: 50%; background: #9ad8c5; box-shadow: 0 0 7px rgba(154,216,197,.50); }
.overview-footer__status .status-dot.busy { background: #ffc048; box-shadow: 0 0 8px rgba(255,192,72,.65); animation: footer-busy 1s ease-in-out infinite; }
@keyframes footer-busy { 50% { opacity: .35; } }
.footer-divider { width: 1px; height: 12px; background: rgba(78,148,153,.24); }
.overview-footer button { display: inline-flex; align-items: center; gap: 6px; border: 1px solid rgba(34,247,255,.40); border-radius: 8px; padding: 9px 14px; color: #eaffff; background: linear-gradient(90deg, rgba(0,201,210,.20), rgba(34,247,255,.26)); box-shadow: 0 0 18px rgba(34,247,255,.15), inset 0 1px 0 rgba(141,255,255,.16); font: inherit; font-size: 12px; font-weight: 700; cursor: pointer; }
