...
.primary-action { display: inline-flex; align-items: center; justify-content: center; gap: 8px; width: 100%; min-height: 44px; margin-top: 22px; border: 1px solid rgba(82, 221, 255, .48); border-radius: 8px; color: #eaffff; background: linear-gradient(90deg, #0aa9b4, #52ddff 52%, #7fd4ff); box-shadow: 0 8px 25px rgba(10, 169, 180, .28), 0 0 18px rgba(82, 221, 255, .22); font: inherit; font-size: 13px; font-weight: 800; text-shadow: 0 0 8px rgba(82, 221, 255, .35); cursor: pointer; }.primary-action:hover { filter: brightness(1.12); transform: translateY(-1px); }
.journey-stage { position: relative; display: grid; grid-template-rows: auto 1fr auto; min-width: 0; overflow: hidden; background: linear-gradient(180deg, rgba(2, 22, 28, .52), rgba(0, 12, 16, .14)); }.journey-copy { position: relative; z-index: 3; padding: 29px 34px 12px; text-align: center; }.journey-copy h1 { max-width: 700px; margin: 10px auto 8px; color: #e5ffff; font-family: "Microsoft YaHei", "Noto Sans SC", sans-serif; font-size: clamp(25px, 2.35vw, 38px); letter-spacing: -.05em; line-height: 1.25; }.journey-copy em { color: #52ddff; font-style: normal; text-shadow: 0 0 10px rgba(82, 221, 255, .65); }.journey-copy p { margin: 0; color: #86b7bc; font-size: 13px; }.video-shell { position: relative; min-height: 332px; margin: 0 18px; overflow: hidden; border: 1px solid rgba(82, 221, 255, .14); border-radius: 12px; background: radial-gradient(ellipse at 48% 87%, rgba(82, 221, 255, .38), transparent 18%), linear-gradient(145deg, #06323a, #011216 80%); }.video-shell::after { position: absolute; inset: 0; background-image: linear-gradient(rgba(141, 255, 255, .07) 1px, transparent 1px), linear-gradient(90deg, rgba(141, 255, 255, .07) 1px, transparent 1px); background-size: 42px 42px; content: ''; opacity: .35; pointer-events: none; }.career-video { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; opacity: .78; mix-blend-mode: screen; }.video-shade { position: absolute; inset: 0; background: linear-gradient(180deg, rgba(2, 18, 22, .28), rgba(0, 12, 16, .33) 42%, rgba(0, 12, 16, .75)); }.journey-route { position: absolute; z-index: 1; top: 53%; left: 12%; width: 73%; height: 34%; border-top: 3px solid rgba(141, 255, 255, .84); border-radius: 48%; box-shadow: 0 -1px 11px rgba(82, 221, 255, .78), 0 -11px 40px rgba(82, 221, 255, .22); transform: rotate(-8deg); }.journey-route::after { position: absolute; top: -42px; right: -4%; width: 30%; height: 70px; border-top: 3px solid #ffc048; border-radius: 50%; box-shadow: 0 -1px 8px rgba(255, 192, 72, .8); content: ''; transform: rotate(17deg); }
.route-stop { position: absolute; z-index: 3; display: grid; grid-template-columns: 30px auto; column-gap: 7px; min-width: 135px; border: 1px solid rgba(82, 221, 255, .36); border-radius: 10px; padding: 8px 10px; color: #dfffff; background: rgba(3, 36, 44, .40); box-shadow: 0 0 14px rgba(82, 221, 255, .08); font: inherit; text-align: left; cursor: pointer; backdrop-filter: blur(18px) saturate(1.15); }.route-stop:hover { border-color: #8dffff; transform: translateY(-3px); }.route-stop b { grid-row: span 2; align-self: center; color: #52ddff; font-size: 19px; text-shadow: 0 0 8px rgba(82, 221, 255, .55); }.route-stop span { font-size: 12px; font-weight: 800; }.route-stop small { margin-top: 3px; color: #7ab2b7; font-size: 10px; }.route-stop--one { bottom: 22px; left: 6%; }.route-stop--two { bottom: 42%; left: 34%; border-color: rgba(145, 210, 190, .34); }.route-stop--two b { color: #8cc8d8; text-shadow: 0 0 8px rgba(154, 216, 197, .26); }.route-stop--three { right: 12%; bottom: 19%; border-color: rgba(186, 142, 255, .48); }.route-stop--three b { color: #c19aff; text-shadow: 0 0 8px rgba(186, 142, 255, .4); }.target-beacon { position: absolute; z-index: 3; top: 20%; right: 7%; display: grid; justify-items: center; text-align: center; }.target-beacon span { display: block; width: 58px; height: 24px; border: 2px solid #52ddff; border-radius: 50%; box-shadow: 0 0 0 8px rgba(82, 221, 255, .10), 0 0 18px rgba(82, 221, 255, .65); animation: beacon 2.7s ease-in-out infinite; }.target-beacon b { margin-top: 9px; color: #e5ffff; font-size: 13px; }.target-beacon small { margin-top: 2px; color: #79a5ab; font-size: 10px; }@keyframes beacon { 50% { transform: scale(1.19); box-shadow: 0 0 0 15px rgba(82, 221, 255, .03), 0 0 28px rgba(82, 221, 255, .78); } }
.journey-steps { position: relative; z-index: 2; display: grid; grid-template-columns: auto 1fr auto 1fr auto 1fr auto; align-items: center; gap: 7px; padding: 13px 30px 18px; color: #6c9196; font-size: 11px; text-align: center; }.journey-steps span.active { color: #52ddff; font-weight: 800; text-shadow: 0 0 8px rgba(82, 221, 255, .6); }.journey-steps i { height: 1px; background: linear-gradient(90deg, #52ddff, rgba(10, 169, 180, .28)); }
.focus-card { display: flex; flex-direction: column; }.focus-card h2 { margin-top: 12px; }.focus-skill { display: flex; align-items: center; gap: 11px; margin-top: 21px; border: 1px solid rgba(82, 221, 255, .13); border-radius: 10px; padding: 13px; background: rgba(4, 54, 63, .22); backdrop-filter: blur(19px) saturate(1.15); }.skill-icon { display: grid; place-items: center; width: 36px; height: 36px; border-radius: 50%; color: #52ddff; background: rgba(10, 169, 180, .12); font-size: 20px; box-shadow: inset 0 0 12px rgba(82, 221, 255, .10); }.focus-skill b,.focus-skill small { display: block; }.focus-skill b { color: #ecffff; font-size: 14px; }.focus-skill small { margin-top: 5px; color: #76a3a8; font-size: 10px; }.focus-progress { height: 6px; margin: 13px 4px 0; overflow: hidden; border-radius: 6px; background: rgba(0, 142, 156, .14); }.focus-progress span { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #0aa9b4, #52ddff); box-shadow: 0 0 9px rgba(82, 221, 255, .38); }.plain-link { display: inline-flex; align-items: center; gap: 4px; margin: 11px 0 16px; border: 0; padding: 0; color: #52ddff; background: transparent; font: inherit; font-size: 11px; font-weight: 700; cursor: pointer; }.recommendation { border-top: 1px solid rgba(82, 221, 255, .08); padding-top: 17px; }.recommendation > span { color: #6c9aa0; font-size: 12px; }.recommendation button { display: grid; grid-template-columns: 28px 1fr 15px; align-items: center; gap: 8px; width: 100%; margin-top: 9px; border: 1px solid rgba(82, 221, 255, .14); border-radius: 9px; padding: 11px; color: #a8f6fb; background: rgba(6, 62, 73, .11); backdrop-filter: blur(18px) saturate(1.12); font: inherit; text-align: left; cursor: pointer; }.recommendation button:hover { border-color: rgba(141, 255, 255, .48); }.recommendation button > .el-icon:first-child { display: grid; place-items: center; width: 28px; height: 28px; border-radius: 6px; color: #52ddff; background: rgba(10, 169, 180, .14); }.recommendation b,.recommendation small { display: block; }.recommendation b { color: #e4ffff; font-size: 11px; }.recommendation small { margin-top: 4px; color: #759da2; font-size: 10px; line-height: 1.4; }.trend-box { margin-top: auto; border-top: 1px solid rgba(82, 221, 255, .10); padding-top: 17px; }.trend-box > div { display: flex; justify-content: space-between; color: #6c9aa0; font-size: 11px; }.trend-box b { color: #8cc8d8; font-size: 16px; text-shadow: 0 0 8px rgba(154, 216, 197, .20); }.trend-box svg { display: block; width: 100%; height: 52px; margin: 5px 0; overflow: visible; }.trend-box path { fill: none; stroke: #8cc8d8; stroke-width: 2.5; filter: drop-shadow(0 0 3px rgba(154, 216, 197, .32)); }.trend-box small { display: flex; justify-content: space-between; color: #68878c; font-size: 9px; }.trend-box i { display: inline-block; width: 5px; height: 5px; margin: 0 4px; border-radius: 50%; background: #8cc8d8; }
.progress-strip { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; margin-top: 15px; }.progress-card { position: relative; display: grid; grid-template-columns: 42px minmax(0, 1fr) auto; align-items: center; gap: 11px; min-height: 91px; overflow: hidden; border: 1px solid rgba(82, 221, 255, .12); border-radius: 13px; padding: 14px 16px 18px; color: inherit; background: rgba(3, 36, 44, .34); box-shadow: inset 0 1px 0 rgba(141, 255, 255, .025); font: inherit; text-align: left; cursor: pointer; backdrop-filter: blur(24px) saturate(1.15); }.progress-card:hover { border-color: rgba(141, 255, 255, .48); transform: translateY(-2px); }.progress-icon { display: grid; place-items: center; width: 41px; height: 41px; border-radius: 50%; color: #52ddff; background: radial-gradient(circle, rgba(82, 221, 255, .24), rgba(0, 122, 131, .08)); font-size: 22px; text-shadow: 0 0 8px rgba(82, 221, 255, .44); }.progress-copy b,.progress-copy small { display: block; }.progress-copy b { color: #e5ffff; font-size: 24px; text-shadow: 0 0 6px rgba(82, 221, 255, .20); }.progress-copy small { margin-top: 5px; color: #78a4a9; font-size: 11px; }.progress-card em { display: inline-flex; align-items: center; gap: 3px; color: #52ddff; font-size: 11px; font-style: normal; white-space: nowrap; }.progress-meter { position: absolute; right: 0; bottom: 0; left: 0; height: 3px; background: rgba(0, 142, 156, .10); }.progress-meter span { display: block; height: 100%; background: linear-gradient(90deg, #0aa9b4, #52ddff); box-shadow: 0 0 7px rgba(82, 221, 255, .40); transform-origin: left; animation: progress-in 1s ease-out both; }@keyframes progress-in { from { transform: scaleX(0); } }
.overview-section { display: grid; gap: 14px; margin-top: 15px; }.action-layout { grid-template-columns: minmax(0, 1.35fr) minmax(360px, .9fr); }.evidence-layout { grid-template-columns: minmax(0, 1.15fr) minmax(380px, 1fr); }.overview-panel { border: 1px solid rgba(82, 221, 255, .11); border-radius: 14px; background: linear-gradient(145deg, rgba(4, 46, 54, .36), rgba(2, 20, 24, .38)); box-shadow: inset 0 1px 0 rgba(141, 255, 255, .025); backdrop-filter: blur(26px) saturate(1.15); }.panel-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 15px; border-bottom: 1px solid rgba(82, 221, 255, .07); padding: 21px 22px 16px; }.panel-heading h2 { margin: 5px 0 5px; color: #e5ffff; font-size: 19px; }.panel-heading p { margin: 0; color: #6e979c; font-size: 11px; }.panel-count { border-radius: 999px; padding: 6px 10px; color: #6feaff; background: rgba(10, 169, 180, .10); font-size: 11px; white-space: nowrap; }.action-list { display: grid; gap: 8px; padding: 12px 18px 18px; }.action-list button { display: grid; grid-template-columns: 34px 1fr auto; align-items: center; gap: 12px; border: 1px solid rgba(82, 221, 255, .10); border-radius: 9px; padding: 12px; color: inherit; background: rgba(3, 36, 44, .22); font: inherit; text-align: left; cursor: pointer; backdrop-filter: blur(20px) saturate(1.12); }.action-list button:hover { border-color: rgba(141, 255, 255, .44); background: rgba(6, 66, 77, .32); }.action-list button > b { display: grid; place-items: center; width: 32px; height: 32px; border: 1px solid rgba(82, 221, 255, .20); border-radius: 8px; color: #6feaff; background: rgba(0, 142, 156, .12); font-size: 12px; text-shadow: 0 0 6px rgba(82, 221, 255, .32); }.action-list strong,.action-list small { display: block; }.action-list strong { color: #e5ffff; font-size: 13px; }.action-list small { margin-top: 5px; color: #6f9499; font-size: 11px; }.action-list em { display: inline-flex; align-items: center; gap: 3px; color: #52ddff; font-size: 11px; font-style: normal; }.milestone-list { display: grid; gap: 0; margin: 0; padding: 14px 24px 19px; list-style: none; }.milestone-list li { position: relative; display: grid; grid-template-columns: 16px 1fr; gap: 11px; padding: 8px 0 14px; }.milestone-list li:not(:last-child)::after { position: absolute; top: 25px; bottom: -1px; left: 7px; width: 1px; background: rgba(0, 142, 156, .16); content: ''; }.milestone-list li > span { position: relative; z-index: 1; width: 14px; height: 14px; margin-top: 2px; border: 2px solid #3e8f94; border-radius: 50%; background: #092c33; }.milestone-list li.done > span { border-color: #8cc8d8; background: #8cc8d8; box-shadow: 0 0 6px rgba(154, 216, 197, .26); }.milestone-list b,.milestone-list small { display: block; }.milestone-list b { color: #e5ffff; font-size: 12px; }.milestone-list small { margin-top: 4px; color: #6f9398; font-size: 10px; }
.outline-button { border: 1px solid rgba(82, 221, 255, .24); border-radius: 7px; padding: 7px 11px; color: #6feaff; background: rgba(0, 142, 156, .10); backdrop-filter: blur(10px); font: inherit; font-size: 11px; cursor: pointer; }.outline-button:hover { background: rgba(0, 178, 188, .20); }.profile-summary { display: flex; align-items: center; gap: 14px; padding: 21px 23px; }.profile-summary > div { flex: 1; min-width: 0; }.profile-summary b,.profile-summary small { display: block; }.profile-summary b { color: #ecffff; font-size: 14px; }.profile-summary b em { color: #52ddff; font-size: 18px; font-style: normal; text-shadow: 0 0 8px rgba(82, 221, 255, .36); }.profile-summary small { margin-top: 6px; color: #6f959a; font-size: 11px; }.evidence-progress { height: 6px; margin-top: 12px; overflow: hidden; border-radius: 999px; background: rgba(0, 142, 156, .14); }.evidence-progress i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #0aa9b4, #52ddff); box-shadow: 0 0 9px rgba(82, 221, 255, .40); }.resume-evidence { display: grid; grid-template-columns: 36px 1fr auto; align-items: center; gap: 11px; margin: 0 22px 22px; border: 1px solid rgba(82, 221, 255, .13); border-radius: 9px; padding: 12px; background: rgba(3, 30, 37, .30); backdrop-filter: blur(18px) saturate(1.12); }.resume-icon { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 7px; color: #52ddff; background: rgba(0, 142, 156, .16); font-size: 18px; }.resume-evidence b,.resume-evidence small { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.resume-evidence b { color: #e5ffff; font-size: 12px; }.resume-evidence small { margin-top: 4px; color: #6f9499; font-size: 10px; }.resume-evidence button { border: 0; padding: 6px 0; color: #52ddff; background: transparent; font: inherit; font-size: 11px; cursor: pointer; }.skill-cloud { display: flex; flex-wrap: wrap; gap: 8px; padding: 20px 22px 13px; }.skill-pill { display: inline-flex; align-items: center; gap: 6px; border: 1px solid rgba(82, 221, 255, .16); border-radius: 999px; padding: 7px 10px; color: #9fdfe5; background: rgba(5, 54, 64, .20); backdrop-filter: blur(14px) saturate(1.10); font: inherit; font-size: 11px; cursor: pointer; }.skill-pill:hover,.skill-pill.active { border-color: rgba(141, 255, 255, .55); color: #e5ffff; }.skill-pill small { color: #52ddff; font-size: 9px; }.skill-pill.missing { border-color: rgba(255, 192, 72, .24); color: #ffd888; }.skill-pill.missing small { color: #ffc048; }.skill-footnote { display: flex; align-items: center; gap: 7px; margin: 0 22px 20px; color: #6f9499; font-size: 11px; }.skill-footnote .el-icon { color: #52ddff; text-shadow: 0 0 6px rgba(82, 221, 255, .40); }
@media (max-width: 1250px) { .career-hero { grid-template-columns: minmax(230px, .82fr) minmax(430px, 1.7fr); }.focus-card { grid-column: span 2; display: grid; grid-template-columns: 1fr 1fr; gap: 10px 22px; border-top: 1px solid rgba(82, 221, 255, .14); border-left: 0; }.focus-card .section-kicker,.focus-card h2 { grid-column: span 2; }.focus-card h2 { margin-top: -7px; }.focus-skill,.recommendation,.trend-box { margin-top: 0; }.trend-box { padding-top: 0; border-top: 0; }.focus-card .plain-link { align-self: end; margin: 0; }.focus-card .recommendation { border-top: 0; padding-top: 0; }.action-layout,.evidence-layout { grid-template-columns: 1fr; } }
@media (max-width: 840px) { .overview-rail { justify-content: flex-start; overflow: auto; }.overview-rail a { white-space: nowrap; }.career-hero { grid-template-columns: 1fr; }.readiness-card,.focus-card { border: 0; border-bottom: 1px solid rgba(82, 221, 255, .14); }.journey-stage { min-height: 520px; order: -1; }.focus-card { grid-column: auto; display: block; }.focus-card h2 { margin-top: 12px; }.focus-card .plain-link { margin: 11px 0 16px; }.focus-card .recommendation,.trend-box { border-top: 1px solid rgba(82, 221, 255, .14); padding-top: 17px; }.progress-strip { grid-template-columns: 1fr 1fr; }.route-stop--three { right: 6%; }.target-beacon { right: 6%; }.journey-copy { padding-right: 20px; padding-left: 20px; }.video-shell { min-height: 290px; }.journey-steps { padding-right: 18px; padding-left: 18px; } }
...
.overview-footer { display: flex; align-items: center; justify-content: space-between; gap: 14px; margin-top: 18px; border: 1px solid rgba(82, 221, 255,.12); border-radius: 10px; padding: 13px 18px; background: rgba(3,28,36,.42); backdrop-filter: blur(22px) saturate(1.15); }
.overview-footer__status { display: flex; align-items: center; gap: 10px; color: #77a0a5; font-size: 12px; }
.overview-footer__status .status-dot { width: 7px; height: 7px; border-radius: 50%; background: #8cc8d8; box-shadow: 0 0 6px rgba(154,216,197,.38); }
...
.overview-footer button { display: inline-flex; align-items: center; gap: 6px; border: 1px solid rgba(82, 221, 255,.34); border-radius: 8px; padding: 9px 14px; color: #eaffff; background: linear-gradient(90deg, rgba(10, 169, 180,.16), rgba(82, 221, 255,.22)); box-shadow: 0 0 14px rgba(82, 221, 255,.11), inset 0 1px 0 rgba(141,255,255,.14); backdrop-filter: blur(14px); font: inherit; font-size: 12px; font-weight: 700; cursor: pointer; }
