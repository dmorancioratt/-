...
const qualityOption = computed(() => ({
  ...
  series: [{ type: 'bar', barWidth: 9, showBackground: true, backgroundStyle: { color: 'rgba(83,137,174,.13)', borderRadius: 5 }, data: [model.value.evaluation.jd_parse_accuracy || 0, model.value.evaluation.resume_parse_accuracy || 0, model.value.evaluation.match_accuracy || 0, model.value.evaluation.unit_test_coverage || 0], itemStyle: { color: '#22f7ff', borderRadius: 5 }, label: { show: true, position: 'right', color: '#d8f6ff', fontSize: 11, formatter: '{c}%' }, animationDuration: 650 }]
}))
...
.service-state { display: inline-flex; align-items: center; gap: 7px; border: 1px solid rgba(34,247,255,.25); border-radius: 6px; padding: 7px 10px; color: #9bb9ce; font-size: 12px; }.service-state i { width: 7px; height: 7px; border-radius: 50%; background: #ffb85c; }.service-state.online { color: #8ff7f4; }.service-state.online i { background: #22f7ff; box-shadow: 0 0 8px rgba(34,247,255,.65); animation: status-breathe 2.4s ease-in-out infinite; }
.governance-brief { display: grid; grid-template-columns: minmax(340px,1.25fr) repeat(4,minmax(180px,.7fr)); gap: 12px; margin-bottom: 14px; }.governance-brief article,.governance-brief > button { min-height: 116px; border: 1px solid rgba(71,191,255,.22); border-radius: 10px; background: rgba(5,23,52,.82); box-shadow: 0 14px 34px rgba(0,3,18,.2); }.governance-score { display: flex; align-items: center; gap: 18px; padding: 14px 18px; }.score-ring { display: grid; width: 84px; height: 84px; flex: 0 0 auto; place-content: center; border-radius: 50%; background: radial-gradient(circle at center,#071b39 55%,transparent 57%),conic-gradient(#22f7ff var(--score),rgba(67,126,166,.18) 0); }.score-ring strong { color: #f5fdff; font-size: 27px; line-height: 1; }.score-ring small { margin-top: 3px; color: #7f9fb7; font-size: 9px; text-align: center; }.governance-score > div:last-child span { color: #8ff7f4; font-size: 12px; font-weight: 800; }.governance-score b { display: block; margin-top: 6px; color: #f1fbff; font-size: 16px; }.governance-score p { margin: 6px 0 0; color: #809fb7; font-size: 11px; line-height: 1.5; }
...
.priority-queue { display: grid; gap: 8px; padding: 4px 16px 16px; }.priority-queue button { display: grid; grid-template-columns: 38px minmax(0,1fr) auto 18px; align-items: center; gap: 12px; min-height: 60px; border: 1px solid rgba(76,145,194,.18); border-radius: 8px; padding: 9px 12px; color: inherit; background: rgba(6,31,64,.55); font: inherit; text-align: left; cursor: pointer; }.priority-queue button:hover { border-color: rgba(255,137,154,.42); background: rgba(18,49,83,.72); }.priority-index { color: #4f7895; font-size: 12px; font-weight: 800; }.priority-queue b { display: block; color: #edfaff; font-size: 13px; }.priority-queue small { display: block; margin-top: 5px; color: #829fb6; font-size: 11px; }.priority-queue em { border-radius: 5px; padding: 5px 7px; color: #ffd094; background: rgba(121,75,18,.25); font-size: 10px; font-style: normal; }.priority-queue em.high { color: #ff9db0; background: rgba(118,26,45,.25); }.priority-queue .el-icon { color: #7194ad; }.all-clear { display: flex; align-items: center; gap: 14px; min-height: 150px; padding: 20px 24px; color: #22f7ff; }.all-clear > .el-icon { font-size: 38px; }.all-clear b,.all-clear small { display: block; }.all-clear b { color: #effcff; font-size: 16px; }.all-clear small { margin-top: 6px; color: #829fb6; font-size: 12px; }
.text-button { border: 0; padding: 5px; color: #8ff7f4; background: transparent; font: inherit; font-size: 11px; cursor: pointer; }.source-table { display: grid; padding: 0 16px 16px; }.source-table > button { display: grid; grid-template-columns: minmax(190px,1fr) 110px minmax(180px,.8fr) 54px; align-items: center; gap: 14px; min-height: 62px; border: 0; border-bottom: 1px solid rgba(73,142,191,.14); color: inherit; background: transparent; font: inherit; text-align: left; cursor: pointer; }.source-table > button:hover { background: rgba(15,68,112,.22); }.source-name b,.source-volume b { display: block; color: #e5f8ff; font-size: 12px; }.source-name small,.source-volume small { display: block; margin-top: 4px; color: #7394ad; font-size: 10px; }.quality-bar { display: grid; grid-template-columns: 1fr 42px; align-items: center; gap: 8px; }.quality-bar i { display: block; height: 6px; overflow: hidden; border-radius: 4px; background: rgba(82,137,176,.16); }.quality-bar em { display: block; height: 100%; border-radius: inherit; background: #22f7ff; transform-origin: left; animation: bar-enter .65s ease-out both; }.quality-bar small { color: #91b2c8; font-size: 10px; }.source-status { border-radius: 5px; padding: 5px 6px; color: #ffd094; background: rgba(121,75,18,.25); font-size: 10px; text-align: center; }.source-status.good { color: #8ff7f4; background: rgba(12,98,168,.24); }
.metrics-chart { height: 220px; padding: 0 12px; }.panel-action { display: flex; align-items: center; justify-content: space-between; width: calc(100% - 32px); margin: 0 16px 15px; border: 0; border-top: 1px solid rgba(75,153,204,.16); padding: 12px 0 0; color: #8ff7f4; background: transparent; font: inherit; font-size: 11px; cursor: pointer; }.model-facts { display: grid; gap: 10px; padding: 4px 16px 12px; }.model-facts div { display: flex; justify-content: space-between; gap: 16px; border-bottom: 1px solid rgba(74,143,191,.12); padding-bottom: 9px; }.model-facts span { color: #7899b1; font-size: 11px; }.model-facts b { color: #e5f7ff; font-size: 11px; }.model-facts b.ok { color: #8ff7f4; }.model-facts b.warn { color: #ffd094; }
.pipeline-panel { margin-top: 14px; }.pipeline-state { color: #7899b1; font-size: 11px; }.pipeline-steps { display: grid; grid-template-columns: repeat(5,minmax(120px,1fr) 36px) minmax(120px,1fr); align-items: center; padding: 8px 18px 18px; }.pipeline-steps button { display: grid; grid-template-columns: 34px 1fr; grid-template-rows: auto auto auto; column-gap: 10px; min-height: 78px; border: 1px solid rgba(73,156,207,.18); border-radius: 8px; padding: 11px; color: inherit; background: rgba(6,31,64,.55); font: inherit; text-align: left; cursor: pointer; }.pipeline-steps button:hover { border-color: rgba(73,208,243,.44); }.step-icon { grid-row: 1 / 4; display: grid; place-items: center; width: 32px; height: 32px; border-radius: 7px; color: #4ed8ff; background: rgba(26,116,177,.2); }.pipeline-steps b { color: #dff5ff; font-size: 11px; }.pipeline-steps strong { margin-top: 3px; color: #8ff7f4; font-size: 13px; }.pipeline-steps small { color: #6f91ad; font-size: 9px; }.pipeline-link { position: relative; height: 1px; overflow: hidden; background: rgba(64,178,223,.22); }.pipeline-link em { position: absolute; width: 12px; height: 100%; background: #4ed8ff; box-shadow: 0 0 8px #4ed8ff; animation: pipeline-flow 2.8s ease-in-out infinite; }
