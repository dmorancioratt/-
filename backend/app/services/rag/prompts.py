...
def analyze_rag(task_type: str, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return ai_module.analyze_with_ai(task_type, clean)
...
def install_mock_patch() -> None:
    ...
    def _patched_analyze_with_mock(task_type, payload):
        ...
        return _original_analyze_with_mock(task_type, payload)

    _ai_module.analyze_with_ai = _patched_analyze_with_ai
    _ai_module.analyze_with_mock = _patched_analyze_with_mock
